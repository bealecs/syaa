...
export default function About() {
  return (
    <article className={`${ar.className} w-10/12 mx-auto my-8`}>
      ...
      <ul className="list-disc my-8 mx-5 text-xl">
        <li className="my-4">
      ...
      <div className="flex">
        <Image
          ...
          height={600}
        />
        <div className="flex-col mx-12 text-xl">
      ...
      <div className="flex mt-12" id="philosophy">
      ...
      <div className="flex mt-12">
        <Image
          ...
          height={600}
        />
        <div className="flex-col text-xl mx-12">
          <h2 className="text-4xl text-blue-700 mb-4 font-semibold">
            Volunteer Driven
          </h2>
          <p>
      ...
      <hr className="my-12"/>
      <h4 className="text-3xl font-semibold text-blue-700">SYAA Organizational Policies</h4>
      <p className="my-4 font-bold">Please note, no pets are allowed beyond the parking lot while on SYAA property.</p>
      <p className="my-4 font-bold">SYAA is a non-smoking facility and no smoking is allowed on or beside playing fields.  Smoking is permitted in our parking lots.</p>
      <h4 className="text-xl font-semibold text-blue-700" >View full policies here:</h4>
      <div className="flex my-4 text-blue-700 text-xl">
      <a className="border-r-2 border-blue-700 pr-4" href="/lightning-policy">Thunder & Lightning Policy</a>
      <a className="border-r-2 border-blue-700 px-4" href="/policy/SYAA-concussion-management-policy.pdf" target="_blank" rel="noopener noreffer">Soccer Concussion Management Policy</a>
      <a className="pl-4" href="/policy/SYAA-Bylaws.pdf" target="_blank" rel="noopener noreffer">SYAA Bylaws</a>
      </div>
    </article>
  );
}
