  ...
  return (
    <div>
      ...
      <h4 className="text-xl font-semibold mt-2">
        SYAA is pleased to offer soccer at all levels from recreational to
      ...
      <div className="h-[50vh] flex justify-center my-12 items-center">
        <div className="min-h-[80%] border-4 border-blue-700 w-3/12 border-r-0">
          ...
          <p className="text-6xl text-blue-700 text-center mt-12 mb-8">
            ...
            <span className="text-3xl text-black">/ player</span>
          </p>
          <p className="mx-2">
            Our Advanced Soccer program was created as an alternative for
            players who want to remain in recreational soccer but play at a
        ...
        <div className="min-h-[100%] border-4 border-blue-700 rounded-md w-3/12">
          ...
          <p className="text-6xl text-blue-700 text-center mt-12 mb-8">
            <span className="text-3xl text-black">$</span>65-100
            <span className="text-3xl text-black">/ player</span>
          </p>
          <p className="mx-2 text-xl">
            Recreational soccer is for players of all abilities and teaches
