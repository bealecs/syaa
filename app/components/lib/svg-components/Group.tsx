export default function Group() {
  return (
    ...
    >
      <rect width="128" height="128" fill="url(#pattern0_33_14)" />
      <defs>
        <pattern
          id="pattern0_33_14"
