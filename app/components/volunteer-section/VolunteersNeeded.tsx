...
export default function VolunteersNeeded() {
    return(
        <section className="w-10/12 mx-auto my-12 flex justify-between">
            <Image src={"./volunteers.svg"} alt="Volunteers of SYAA" width={500} height={500} />
            <div className="flex flex-col w-8/12 text-xl mt-4">
                <h3 className="text-blue-700 font-semibold text-2xl">How to get involved</h3>
